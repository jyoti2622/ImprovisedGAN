...
# %% [code] {"_execution_state":"idle","jupyter":{"outputs_hidden":true}}
# libraries
#%matplotlib notebook
...
# %% [code] {"_execution_state":"idle","jupyter":{"outputs_hidden":true}}
path = Path.cwd().joinpath("data","nab", "archive", "realKnownCause", "realKnownCause", "ambient_temperature_system_failure.csv")
df = pd.read_csv(path)
